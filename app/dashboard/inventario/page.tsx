        ...
        <header className="mb-10 flex flex-col md:flex-row justify-between md:items-end gap-6">
          <div>
            ...
            <h1 className="text-4xl font-black text-[#0f172a] uppercase italic leading-none tracking-tighter">
              Catálogo de <span className="text-[#1e3a8a]">Economato</span>
            </h1>
          ...
          <div className="flex gap-4 items-center w-full md:w-auto">
            ...
            <button 
              ...
              className="px-8 py-4 bg-[#1e3a8a] text-white rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-lg hover:bg-blue-800 transition-all whitespace-nowrap"
            >
              + Novo Artigo
            </button>
          </div>
